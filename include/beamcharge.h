...
public:
  ...
  const std::vector<double>& get_bunches() const { return bunches; }
  const double& get_elastic_lifetime() const { return elastic_lifetime; };
  const double& get_inelastic_lifetime() const { return inelastic_lifetime; };
  const double& get_quantum_lifetime() const { return quantum_lifetime; };
  const double& get_touschek_coefficient() const { return touschek_coefficient; };
...
protected:
  ...
  double elastic_lifetime;
  double inelastic_lifetime;
  double quantum_lifetime;
